...
static void *frame_buffers[2] = {nullptr, nullptr};
...
void ST7701_Init()
{
  ...
  esp_lcd_rgb_panel_get_frame_buffer(panel_handle, ESP_PANEL_LCD_RGB_FRAME_BUF_NUM,
...
void* LCD_GetFrameBuffer(uint8_t index) {
  if (index >= ESP_PANEL_LCD_RGB_FRAME_BUF_NUM) {
    return nullptr;
  }
