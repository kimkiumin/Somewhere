...
async function boundSyntheticFixture(label: string) {
  ...
  const promotion = {
    ...
    expandedStudyAAggregateSha256: "5".repeat(64),
    nativeBuildReceiptSha256: "6".repeat(64),
    pwaBuildReceiptSha256: "7".repeat(64),
    routeContractSha256: "8".repeat(64),
    providerConfigSha256: "9".repeat(64),
    sessionSchemaSha256: "a".repeat(64),
    aggregateSchemaSha256: "b".repeat(64),
    physicalGate: "PASS",
    sessionCount: 5,
    unsafeEventCount: 0,
