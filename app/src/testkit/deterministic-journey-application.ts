import type { SensorController, SensorSnapshot } from "../application/controller";
import type { DiagnosticSessionMetadata, DiagnosticTrace } from "../application/diagnostics";
import { createJourneyDiagnosticRecorder } from "../application/journey-diagnostics";
import { createJourneyFreshnessWatchdog } from "../application/journey-freshness";
import { deriveJourneyGuidance, type JourneyGuidance } from "../application/journey-guidance";
import {
  activeDestination,
  activeDestinationId,
