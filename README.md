...
The approved vNext blueprint governs future work. The v0.1 material below remains a runnable historical prototype rather than an active vNext product contract.

## Historical v0.1 Prototype
