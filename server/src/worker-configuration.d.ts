/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=server/wrangler.jsonc server/src/worker-configuration.d.ts` (hash: cf806fa852bb66826fce0e7989bd388b)
