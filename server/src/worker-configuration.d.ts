/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=server/wrangler.jsonc server/src/worker-configuration.d.ts` (hash: 5008a3aadc5ade68382dcbfc465bcb2d)
